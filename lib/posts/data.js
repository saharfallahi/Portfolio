export const posts = [
  ...
  },
  {
    ...
    title: "چک‌لیست کامل سئو برای پروژه‌های Next.js: از صفر تا صد",
    summary:
      "اگر می‌خواهید سایت Next.js شما در گوگل رتبه بهتری بگیرد، این چک‌لیست جامع را دنبال کنید. از متادیتا و تصاویر تا Core Web Vitals و ساختار داده‌ها - همه چیز به زبان ساده.",
    description:
      "راهنمای کامل و کاربردی برای بهینه‌سازی سئو در Next.js: از تنظیمات اولیه تا تکنیک‌های پیشرفته برای بهبود رتبه در موتورهای جستجو.",
    coverImage: "/blog/nextjs-seo-checklist.svg",
    tags: ["SEO", "Next.js", "Performance", "Core Web Vitals", "بهینه‌سازی"],
    date: "2025-01-21",
    readTime: "۱۲ دقیقه مطالعه",
    keywords: [
      "Next.js SEO checklist",
      "بهینه سازی سئو Next.js",
    ...
    content: [
      {
        type: "paragraph",
        text: "ساخت یک سایت با Next.js کار ساده‌ای است، اما اگر می‌خواهید در گوگل پیدا شوید، باید چند کار مهم را انجام دهید. در این مقاله یک چک‌لیست کامل و کاربردی برای شما آماده کرده‌ام که می‌توانید قدم به قدم آن را دنبال کنید.",
      },
      {
        type: "heading",
        text: "۱. تنظیم متادیتا (Metadata) - اولین قدم مهم",
      },
      {
        type: "paragraph",
        text: "متادیتا همان اطلاعاتی است که گوگل و سایر موتورهای جستجو از صفحه شما می‌بینند. در Next.js 13+ (با App Router) می‌توانید از `generateMetadata` استفاده کنید.",
      },
      {
        type: "paragraph",
        text: "مثال عملی:",
      ...
      {
        type: "heading",
        text: "۲. Open Graph و Twitter Cards - برای شبکه‌های اجتماعی",
      },
      {
        type: "paragraph",
        text: "وقتی لینک سایت شما در تلگرام، توییتر یا اینستاگرام به اشتراک گذاشته می‌شود، این تگ‌ها تعیین می‌کنند چه تصویر و متنی نمایش داده شود.",
      },
      {
        type: "list",
        items: [
          "og:title: عنوان صفحه برای شبکه‌های اجتماعی",
          "og:description: توضیحات صفحه",
          "og:image: تصویر شاخص (حداقل 1200x630 پیکسل)",
          "og:url: آدرس کامل صفحه",
          "twitter:card: نوع کارت توییتر (معمولاً `summary_large_image`)",
        ],
      },
      {
        type: "paragraph",
        text: "در Next.js می‌توانید این موارد را در `generateMetadata` اضافه کنید:",
      },
      {
        type: "code",
      ...
      {
        type: "heading",
        text: "۳. بهینه‌سازی تصاویر - تأثیر مستقیم روی سرعت",
      },
      {
        type: "paragraph",
      ...
      {
        type: "heading",
        text: "۴. ساختار URL - ساده و خوانا",
      },
      {
        type: "paragraph",
      ...
      {
        type: "heading",
        text: "۵. Structured Data (JSON-LD) - کمک به گوگل",
      },
      {
        type: "paragraph",
        text: "Structured Data به گوگل کمک می‌کند محتوای صفحه شما را بهتر بفهمد. برای مقالات، محصولات، سازمان‌ها و غیره می‌توانید از آن استفاده کنید.",
      },
      {
        type: "paragraph",
        text: "مثال برای یک مقاله:",
      },
      {
        type: "code",
      ...
      {
        type: "heading",
        text: "۶. Core Web Vitals - معیارهای عملکرد",
      },
      {
        type: "paragraph",
        text: "گوگل از سه معیار اصلی برای سنجش کیفیت سایت استفاده می‌کند:",
      },
      {
        type: "list",
        items: [
      ...
      },
      {
        type: "list",
        items: [
          "LCP: تصویر اصلی را با `priority` بارگذاری کنید، از فونت‌های بهینه استفاده کنید",
          "FID: JavaScript را بهینه کنید، از Code Splitting استفاده کنید",
          "CLS: برای تصاویر و ویدیوها width و height مشخص کنید",
        ],
      },
      {
        type: "heading",
        text: "۷. Sitemap و Robots.txt",
      },
      {
        type: "paragraph",
        text: "این دو فایل به گوگل می‌گویند کدام صفحات را ایندکس کند و کدام را نه.",
      },
      {
        type: "list",
        items: [
          "Sitemap: لیست تمام صفحات سایت شما (در Next.js می‌توانید به صورت خودکار تولید کنید)",
          "Robots.txt: دستورالعمل‌هایی برای خزنده‌های موتورهای جستجو",
        ],
      },
      {
        type: "paragraph",
        text: "در Next.js 13+ می‌توانید `sitemap.js` و `robots.js` در پوشه `app` بسازید.",
      },
      {
        type: "heading",
        text: "۸. بهینه‌سازی فونت‌ها",
      },
      {
        type: "paragraph",
      ...
      {
        type: "paragraph",
        text: "بعد از انجام تمام موارد بالا، حتماً سایت خود را تست کنید:",
      },
      {
        type: "list",
        items: [
          "Google Search Console: برای بررسی ایندکس شدن صفحات",
          "Google PageSpeed Insights: برای بررسی سرعت و Core Web Vitals",
          "Lighthouse: ابزار Chrome DevTools برای بررسی کامل SEO و Performance",
          "Mobile-Friendly Test: برای اطمینان از سازگاری با موبایل",
        ],
      },
      {
        type: "heading",
      ...
      {
        type: "paragraph",
        text: "برای راحتی، این چک‌لیست را پرینت کنید و بعد از هر تغییر بررسی کنید:",
      },
      {
        type: "list",
        items: [
          "✅ عنوان و توضیحات برای هر صفحه تنظیم شده",
          "✅ Open Graph و Twitter Cards اضافه شده",
          "✅ تصاویر با next/image و alt text بهینه شده",
          "✅ URL های ساده و خوانا",
          "✅ Structured Data برای مقالات/محصولات",
          "✅ Sitemap و Robots.txt تنظیم شده",
          "✅ Core Web Vitals در حد قابل قبول",
          "✅ فونت‌ها بهینه شده",
          "✅ JavaScript بهینه شده (Dynamic Import)",
          "✅ تست با Google Search Console و PageSpeed Insights",
        ],
      },
      {
        type: "heading",
      ...
      {
        type: "paragraph",
        text: "بهینه‌سازی سئو یک فرایند مداوم است. این چک‌لیست را برای هر صفحه جدید یا بعد از هر تغییر بزرگ در سایت اجرا کنید. یادتان باشد که گوگل چند هفته تا چند ماه زمان می‌برد تا تغییرات را ببیند، پس صبور باشید و به کار خود ادامه دهید!",
      },
      {
        type: "quote",
        text: "نکته مهم: سئو یک ماراتن است، نه دوی سرعت. با صبر و پشتکار و رعایت این نکات، به مرور زمان رتبه سایت شما بهبود خواهد یافت.",
      },
    ],
  },
];
