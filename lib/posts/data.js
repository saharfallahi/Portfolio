export const posts = [
  {
    ...
    content: [
      ...
      {
        type: "html",
        text: "اگر دوست دارید عمیق‌تر یاد بگیرید که از View Page Source چه اطلاعاتی می‌شود استخراج کرد، پیشنهاد می‌کنم این مقاله را هم بخوانید: View Page Source: چه اطلاعاتی از کد منبع یک وب‌سایت می‌توانیم استخراج کنیم؟",
        html: 'اگر دوست دارید عمیق‌تر یاد بگیرید که از View Page Source چه اطلاعاتی می‌شود استخراج کرد، پیشنهاد می‌کنم این مقاله را هم بخوانید: <a href="/blog/view-page-source-for-developers" class="text-[var(--primary)] hover:underline">View Page Source: چه اطلاعاتی از کد منبع یک وب‌سایت می‌توانیم استخراج کنیم؟</a>.',
      },
      {
        type: "heading",
  ...
  },
  {
    ...
    content: [
      {
        type: "paragraph",
        text: "اگر می‌خواهید سایت Next.js شما در گوگل پیدا شود و رتبه بهتری بگیرید، باید یکسری کارهای فنی و محتوایی را به‌صورت کامل انجام دهید. Next.js امکانات خوبی برای سئو دارد، اما به‌تنهایی کافی نیست. در این راهنمای جامع، تمام مراحل از تنظیم metadata و Search Console تا بهینه‌سازی Core Web Vitals را قدم به قدم با مثال‌های عملی و مسیر فایل‌ها توضیح داده‌ایم.",
      },
      {
        type: "heading",
        text: "قبل از شروع",
      ...
      {
        type: "paragraph",
        text: "این راهنما برای سایت‌های Next.js 13+ با App Router نوشته شده است. اگر از Pages Router استفاده می‌کنید، برخی مراحل متفاوت خواهد بود.",
      },
      {
        type: "heading",
  ...
  {
    slug: "best-cms-for-nextjs",
    title: "بهترین CMS برای پروژه‌های Next.js: راهنمای کامل انتخاب",
    summary:
      "اگر می‌خواهید محتوای سایت Next.js خود را به راحتی مدیریت کنید، باید یک CMS مناسب انتخاب کنید. در این مقاله با بهترین CMS های Headless برای Next.js آشنا می‌شوید و یاد می‌گیرید چطور بهترین انتخاب را داشته باشید.",
    description:
      "راهنمای جامع انتخاب CMS برای Next.js: معرفی و مقایسه Contentful، Sanity، Strapi، Payload CMS، Headless WordPress و سایر CMS های محبوب. مزایا، معایب و راهنمای انتخاب مناسب برای هر پروژه.",
    coverImage: "/blog/best-cms-nextjs.svg",
    tags: [
      "Next.js",
      "CMS",
      "Headless CMS",
    ...
    keywords: [
      ...
      "Strapi",
      "بهترین CMS",
      "مدیریت محتوا Next.js",
    ],
    content: [
      {
        type: "paragraph",
        text: "وقتی یک پروژه Next.js می‌سازید، احتمالاً می‌خواهید محتوای سایت را بدون نیاز به تغییر کد، به راحتی مدیریت کنید. اینجاست که CMS (Content Management System) به کمک شما می‌آید. اما کدام CMS برای Next.js بهتر است؟ در این مقاله با بهترین گزینه‌ها آشنا می‌شوید و یاد می‌گیرید چطور انتخاب درستی داشته باشید.",
      },
      {
        type: "heading",
        text: "CMS چیست و چرا به آن نیاز داریم؟",
      },
      {
        type: "paragraph",
        text: "CMS یا سیستم مدیریت محتوا، یک ابزار است که به شما امکان می‌دهد محتوای سایت را بدون نیاز به کدنویسی، از طریق یک رابط کاربری ساده مدیریت کنید. برای مثال، اگر یک بلاگ دارید، می‌توانید با CMS پست‌های جدید اضافه کنید، ویرایش کنید یا حذف کنید، بدون اینکه نیاز باشد کد HTML یا JavaScript بنویسید.",
      },
      {
        type: "paragraph",
        text: "در دنیای Next.js، معمولاً از Headless CMS استفاده می‌شود. Headless یعنی CMS فقط محتوا را مدیریت می‌کند و رابط کاربری (frontend) را به شما می‌سپارد. این یعنی شما با Next.js رابط کاربری خود را می‌سازید و محتوا را از CMS می‌گیرید.",
      },
      {
        type: "heading",
        text: "چرا Headless CMS برای Next.js مناسب است؟",
      },
      {
        type: "list",
        items: [
      ...
      {
        type: "heading",
        text: "بهترین CMS های Headless برای Next.js",
      },
      {
        type: "paragraph",
        text: "حالا بیایید با بهترین CMS های Headless که با Next.js به خوبی کار می‌کنند آشنا شویم:",
      },
      {
        type: "heading",
        text: "۱. Contentful",
      ...
      {
        type: "paragraph",
        text: "Contentful یکی از محبوب‌ترین و قدرتمندترین CMS های Headless است که توسط شرکت‌های بزرگ استفاده می‌شود.",
      },
      {
        type: "list",
        items: [
      ...
      {
        type: "paragraph",
        text: "Contentful برای پروژه‌های بزرگ و حرفه‌ای که نیاز به مدیریت محتوای پیچیده دارند، انتخاب مناسبی است.",
      },
      {
        type: "heading",
        text: "۲. Sanity",
      ...
      {
        type: "paragraph",
        text: "Sanity یک CMS مدرن و منبع باز است که به خاطر رابط کاربری قابل تنظیم و تجربه توسعه عالی معروف است.",
      },
      {
        type: "list",
        items: [
      ...
      {
        type: "paragraph",
        text: "Sanity برای توسعه‌دهندگانی که می‌خواهند یک CMS قدرتمند و قابل تنظیم داشته باشند، انتخاب عالی است.",
      },
      {
        type: "heading",
        text: "۳. Strapi",
      ...
      {
        type: "paragraph",
        text: "Strapi یک CMS منبع باز و خودمیزبان (self-hosted) است که می‌توانید آن را روی سرور خود نصب کنید.",
      },
      {
        type: "list",
        items: [
      ...
      {
        type: "paragraph",
        text: "Strapi برای کسانی که می‌خواهند کنترل کامل روی داده‌ها و سرور داشته باشند، انتخاب مناسبی است.",
      },
      {
        type: "heading",
        text: "۴. Payload CMS",
      ...
      {
        type: "paragraph",
        text: "Payload یک CMS مدرن و TypeScript-first است که به طور خاص برای توسعه‌دهندگان JavaScript ساخته شده است.",
      },
      {
        type: "list",
        items: [
      ...
      {
        type: "paragraph",
        text: "Payload برای توسعه‌دهندگان TypeScript که می‌خواهند یک CMS مدرن و Type-safe داشته باشند، انتخاب خوبی است.",
      },
      {
        type: "heading",
        text: "۵. Headless WordPress",
      },
      {
        type: "paragraph",
        text: "WordPress محبوب‌ترین CMS دنیا است و می‌توانید از آن به عنوان Headless CMS هم استفاده کنید.",
      },
      {
        type: "list",
        items: [
      ...
      {
        type: "paragraph",
        text: "اگر قبلاً با WordPress کار کرده‌اید و می‌خواهید از همان اکوسیستم استفاده کنید، Headless WordPress می‌تواند انتخاب خوبی باشد.",
      },
      {
        type: "heading",
        text: "۶. Prismic",
      ...
      {
        type: "paragraph",
        text: "Prismic یک CMS Headless ساده و کاربرپسند است که برای تیم‌های کوچک و متوسط مناسب است.",
      },
      {
        type: "list",
        items: [
      ...
      {
        type: "heading",
        text: "۷. Hygraph (قبلاً GraphCMS)",
      },
      {
        type: "paragraph",
        text: "Hygraph یک CMS مدرن است که از GraphQL استفاده می‌کند و برای توسعه‌دهندگان React و Next.js بهینه شده است.",
      },
      {
        type: "list",
        items: [
      ...
      {
        type: "heading",
        text: "مقایسه سریع CMS ها",
      },
      {
        type: "paragraph",
        text: "برای اینکه راحت‌تر تصمیم بگیرید، این جدول مقایسه را ببینید:",
      },
      {
        type: "list",
        items: [
      ...
      {
        type: "heading",
        text: "چطور CMS مناسب را انتخاب کنیم؟",
      },
      {
        type: "paragraph",
        text: "برای انتخاب CMS مناسب، این سوالات را از خود بپرسید:",
      },
      {
        type: "list",
        items: [
      ...
      {
        type: "paragraph",
        text: "انتخاب CMS مناسب برای پروژه Next.js شما بستگی به نیازها، بودجه و تجربه شما دارد. اگر پروژه کوچک و شخصی دارید، می‌توانید با Prismic یا Sanity (رایگان) شروع کنید. اگر پروژه بزرگ و حرفه‌ای دارید، Contentful یا Sanity (پولی) انتخاب بهتری است. اگر می‌خواهید کنترل کامل داشته باشید، Strapi یا Payload را انتخاب کنید.",
      },
      {
        type: "quote",
        text: "نکته مهم: بهترین CMS، CMS ای است که نیازهای شما را برآورده کند و تیم شما بتواند با آن راحت کار کند. قبل از تصمیم نهایی، چند CMS را امتحان کنید و ببینید کدام برای شما مناسب‌تر است.",
      },
      {
        type: "paragraph",
        text: "بهترین راه این است که با یک CMS ساده شروع کنید و اگر نیاز به امکانات بیشتری داشتید، به CMS پیشرفته‌تر مهاجرت کنید. یادتان باشد که تغییر CMS در آینده ممکن است، اما بهتر است از همان اول انتخاب درستی داشته باشید.",
      },
    ],
  },
];
